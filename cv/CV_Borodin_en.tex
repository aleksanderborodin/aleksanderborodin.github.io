...
\hypersetup{
  pdftitle={Aleksander Borodin -- Data Science / AI Agents},
...
\setlist[itemize]{leftmargin=1.0em,itemsep=0.10em,topsep=0.10em,parsep=0pt,partopsep=0pt}
...
\begin{document}
\fontsize{9.60}{11.00}\selectfont
\raggedright

\begin{minipage}[c]{0.78\textwidth}
  {\LARGE\bfseries Aleksander Borodin}\par
  \vspace{0.04em}
  {\large Data Science / AI Agents}\par
  \vspace{0.16em}
...
Data scientist and AI agent developer focused on LLM systems, RAG, multi-agent workflows, model evaluation/safety, and applied optimization. I build backend services, LLM integrations, evaluation loops, dashboards, and research prototypes.
...
\begin{itemize}
  ...
  \item Integrated LLM provider APIs and smart-router functionality for model/provider selection.
  \item Made product decisions across user flows, positioning, and service behavior. Stack: Python, LLM APIs, product design.
\end{itemize}
}
