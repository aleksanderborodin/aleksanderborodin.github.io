# Hi, I'm Aleksander Borodin

**NLP / AI Developer** · MIPT FPMI, Applied Mathematics and Computer Science (class of 2027)
...
- **LLM safety research** — prefix-injection attacks and choice-blindness-inspired jailbreaks against frontier models (Gemini 2.5 Pro, DeepSeek R1).
- **Multi-agent systems** — evolutionary frameworks where specialized Claude agents collaborate to solve hard optimization problems.
- **Commercial AI** — currently building [ModelGate.ru](https://modelgate.ru), an LLM API gateway and proxy service.
...
- **ModelGate.ru** (2025 – present) — LLM API gateway / proxy service. PM and AI-assisted coding.
- **Royal Credit Bank** (2024 – 2025) — Cash-collection optimization algorithm (projected +20M RUB/yr), CBR web-scraping pipeline, internal RAG for document Q&A.

## Stack

`Python` · `PyTorch` · `Transformers` · `LangChain` · `FastAPI` · `PostgreSQL` · `Docker`
Comfortable across the full LLM lifecycle: fine-tuning, evaluation, retrieval, agentic orchestration, and red-teaming.
